...
extension MineUserEditPopView {
    private func createUI() {
        ...
        self.addGradientLayer(colors: UIColor.popupBgColors(), frame: CGRect(origin: .zero, size: CGSize(width: UIScreen.screenWidth-48, height: 461)))
    ...
    private func createUILimit() {
        let height = (APPManager.default.loginUserModel?.user?.headPic ?? "").isValidStr ? 461.0 : 400.0
