...
extension HomeReportPopView {
    ...
    private func createUILimit() {
        ...
        self.addGradientLayer(colors: UIColor.popupBgColors(), frame: CGRect(x: 0, y: 0, width: UIScreen.screenWidth-40, height: viewHeight))
...
class HomeReportReasonCell: UITableViewCell {
    ...
    let norImage = UIImage.createColorImg(color: UIColor.whiteColor(alpha: 0.3))
